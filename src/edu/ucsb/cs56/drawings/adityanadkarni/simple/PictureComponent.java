package edu.ucsb.cs56.drawings.adityanadkarni.simple;
...
/**
   A component that draws a Picture by Aditya Nadkarni

   @author Phill Conrad (original drawing)
   @author Aditya Nadkarni (fixed the snowmans's head)
...
public class PictureComponent extends JComponent
{
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Snowman by Aditya Nadkarni", 20,20);
