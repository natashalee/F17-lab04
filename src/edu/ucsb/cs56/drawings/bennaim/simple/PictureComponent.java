package edu.ucsb.cs56.drawings.bennaim.simple;
...
/**
   A component that draws a Picture by Daniel Ben-Naim
   
   @author Phill Conrad (original drawing)
   @author Daniel Ben-Naim (fixed the snowmans's head)
...
{  
	...
	g2.draw(snowManTopCircle);
        ...
        g2.drawString("Snowman by Daniel Ben-Naim", 20,20);
